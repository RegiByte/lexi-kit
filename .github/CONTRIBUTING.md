# Contributing to Lexi-Kit Primitives

## Code of Conduct

Lexi-Kit has adopted the [Contributor Covenant](https://www.contributor-covenant.org/) as its Code of Conduct, and we expect project participants to adhere to it.
...
- Priority is the best Dev/User Experience
- Components should expose their behavior when possible through hooks
...
If you have questions about Lexi-Kit Primitives, be sure to check out the docs where we have several examples and detailed API references that may help you solve your problem. You can also share your questions on [GitHub Discussions](https://github.com/RegiByte/lexi-kit/discussions).
...
- **Support.** You can answer questions on StackOverflow or [GitHub Discussions](https://github.com/RegiByte/lexi-kit/discussions), or provide solutions for others in [open issues](https://github.com/RegiByte/lexi-kit/issues).
...
```sh
git clone https://github.com/<your username>/lexi-Kit.git
cd primitives
git remote add upstream https://github.com/RegiByte/lexi-kit.git
```
...
7. Go to [the repository](https://github.com/RegiByte/lexi-kit) and [make a Pull Request](https://docs.github.com/en/free-pro-team@latest/github/collaborating-with-issues-and-pull-requests/creating-a-pull-request).
